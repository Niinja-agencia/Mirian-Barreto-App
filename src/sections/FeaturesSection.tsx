...
const features = [
  {
    ...
    descPt: 'Videoaulas gravadas com instrução detalhada, como se a Mirian estivesse ao seu lado — sendo sua parceira de treino e personal.',
    descEn: 'Recorded video classes with detailed instruction, as if Mirian was by your side — being your training partner and personal trainer.',
  ...
  },
  {
    ...
    titlePt: 'Treino feito para você',
    titleEn: 'Workout made for you',
    descPt: 'Programas adaptados ao seu nível, objetivo e disponibilidade. Emagrecimento, ganho de massa, definição ou condicionamento.',
    descEn: 'Programs adapted to your level, goal and availability. Weight loss, muscle gain, definition or conditioning.',
