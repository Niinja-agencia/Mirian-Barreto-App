    ...
    <div className="min-h-screen bg-[var(--color-warm-grey)]">
      ...
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col bg-[var(--color-black)] p-5 md:flex">
        ...
        <button
          ...
          className="mt-auto flex items-center gap-3 rounded-lg px-3.5 py-2.5 text-sm font-medium text-[rgba(255,255,255,0.7)] transition-colors hover:bg-[rgba(255,255,255,0.06)] hover:text-white"
        >
          <LogOut size={18} /> Sair
        </button>
      </aside>
      ...
      {open && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute inset-y-0 left-0 w-72 bg-[var(--color-black)] p-5 flex flex-col">
            ...
            <button
              onClick={handleLogout}
              className="mt-auto flex items-center gap-3 rounded-lg px-3.5 py-2.5 text-sm font-medium text-[rgba(255,255,255,0.7)] hover:text-white"
            >
              <LogOut size={18} /> Sair
            </button>
          </div>
